...
- label: Clarify Spec Requirements
  ...
  send: true
scripts:
  sh: .specify/extensions/agentic-sdlc/scripts/bash/create-new-feature.sh "{ARGS}"
  ps: .specify/extensions/agentic-sdlc/scripts/powershell/create-new-feature.ps1 "{ARGS}"
---
