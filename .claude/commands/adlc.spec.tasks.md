...
- label: Implement Project
  ...
  send: true
scripts:
  sh: .specify/extensions/agentic-sdlc/scripts/bash/check-prerequisites.sh --json
  ps: .specify/extensions/agentic-sdlc/scripts/powershell/check-prerequisites.ps1
    -Json
---
