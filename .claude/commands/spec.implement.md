...
description: Execute the implementation plan by processing and executing all tasks
  defined in tasks.md
scripts:
  sh: .specify/extensions/agentic-sdlc/scripts/bash/implement.sh "$(scripts/bash/check-prerequisites.sh
    --json --require-tasks --include-tasks)"
  ps: .specify/extensions/agentic-sdlc/scripts/powershell/implement.ps1 "$(scripts/powershell/check-prerequisites.ps1
